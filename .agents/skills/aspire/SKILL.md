...
- Use `features.defaultWatchEnabled` only for Aspire default watch. It is AppHost-centered and restart-based for the AppHost-managed application, supports C# and TypeScript AppHosts, and currently controls C# project resources.
